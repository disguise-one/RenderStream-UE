        ...
        FVector2D CropV)
    {
        ...
        else if (toggle == "D3D12")
        {
...

            {
                ...
                RenderStreamLink::instance().rs_sendFrame(Handle, RenderStreamLink::SenderFrameType::RS_FRAMETYPE_DX12_TEXTURE, data, &FrameData); // this signals data.dx12.fenceValue + 1
            }
        }
        else
        {
